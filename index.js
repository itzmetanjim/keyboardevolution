...
As of 2018, public access to YouTube is blocked by China, North Korea, Iran, Turkmenistan,[252] Uzbekistan,[253][254] Tajikistan, Eritrea, Sudan and South Sudan mostly due to freedom of speech laws. In some countries, YouTube is blocked for more limited periods of time, such as during periods of unrest, the run-up to an election, or in response to upcoming political anniversaries. In cases where the entire site is banned due to one particular video, YouTube will often agree to remove or limit access to that video in order to restore service.[246]
...
Morocco blocked access in May 2007, possibly as a result of videos critical of Morocco's occupation of Western Sahara.[257] YouTube became accessible again on May 30, 2007, after Maroc Telecom unofficially announced that the denied access to the website was a mere "technical glitch".[258]
Turkey blocked access between 2008 and 2010 after controversy over videos deemed insulting to Mustafa Kemal Atatürk.[259][260][261] In November 2010, a video of the Turkish politician Deniz Baykal caused the site to be blocked again briefly, and the site was threatened with a new shutdown if it did not remove the video.[262] During the two and a half-year block of YouTube, the video-sharing website remained the eighth-most-accessed site in Turkey.[263][264] In 2014, Turkey blocked the access for the second time, after "a high-level intelligence leak".[265][266][267]
Pakistan blocked access on February 23, 2008, because of "offensive material" towards the Islamic faith, including display of the Danish cartoons of Muhammad.[268] This led to a near global blackout of the YouTube site for around two hours, as the Pakistani block was inadvertently transferred to other countries. On February 26, 2008, the ban was lifted after the website had removed the objectionable content from its servers at the request of the government.[269][270] Many Pakistanis circumvented the three-day block by using virtual private network software.[271] In May 2010, following the Everybody Draw Mohammed Day, Pakistan again blocked access to YouTube, citing "growing sacrilegious content".[272] The ban was lifted on May 27, 2010, after the website removed the objectionable content from its servers at the request of the government. However, individual videos deemed offensive to Muslims posted on YouTube will continue to be blocked.[273][274] Pakistan again placed a ban on YouTube in September 2012, after the site refused to remove the film Innocence of Muslims. The ban was lifted in January 2016 after YouTube launched a Pakistan-specific version.[275]
Libya blocked access on January 24, 2010, because of videos that featured demonstrations in the city of Benghazi by families of detainees who were killed in Abu Salim prison in 1996, and videos of family members of Libyan leader Muammar Gaddafi at parties. The blocking was criticized by Human Rights Watch.[276] In November 2011, after the Libyan Civil War, YouTube was once again allowed in Libya.[277]
...
Bans by YouTube
Following U.S. government foreign policy decisions, YouTube has censored content posted by a number of organizations:
...
Private individuals,[289] as well as large production corporations,[290] have used YouTube to grow their audiences. Indie creators have built grassroots followings numbering in the thousands at very little cost or effort, while mass retail and radio promotion proved problematic.[289] Concurrently, old media celebrities moved into the website at the invitation of a YouTube management that witnessed early content creators accruing substantial followings and perceived audience sizes potentially larger than that attainable by television.[290] While YouTube's revenue-sharing "Partner Program" made it possible to earn a substantial living as a video producer—its top five hundred partners each earning more than $100,000 annually[291] and its ten highest-earning channels grossing from $2.5 million to $12 million[292]—in 2012 CMU business editor characterized YouTube as "a free-to-use ... promotional platform for the music labels."[293] In 2013, Katheryn Thayer of Forbes asserted that digital-era artists' work must not only be of high quality, but must elicit reactions on the YouTube platform and social media.[294] Videos of the 2.5% of artists categorized as "mega", "mainstream" and "mid-sized" received 90.3% of the relevant views on YouTube and Vevo in that year.[295] By early 2013, Billboard had announced that it was factoring YouTube streaming data into calculation of the Billboard Hot 100 and related genre charts.[296]


Jordan Hoffner at the 68th Annual Peabody Awards accepting for YouTube
Observing that face-to-face communication of the type that online videos convey has been "fine-tuned by millions of years of evolution", TED curator Chris Anderson referred to several YouTube contributors and asserted that "what Gutenberg did for writing, online video can now do for face-to-face communication."[297] Anderson asserted that it is not far-fetched to say that online video will dramatically accelerate scientific advance, and that video contributors may be about to launch "the biggest learning cycle in human history."[297] In education, for example, the Khan Academy grew from YouTube video tutoring sessions for founder Salman Khan's cousin into what Forbes' Michael Noer called "the largest school in the world", with technology poised to disrupt how people learn.[298] YouTube was awarded a 2008 George Foster Peabody Award,[299] the website being described as a Speakers' Corner that "both embodies and promotes democracy".[300] The Washington Post reported that a disproportionate share of YouTube's most-subscribed channels feature minorities, contrasting with mainstream television in which the stars are largely white.[301] A Pew Research Center study reported the development of "visual journalism", in which citizen eyewitnesses and established news organizations share in content creation.[302] The study also concluded that YouTube was becoming an important platform by which people acquire news.[303]
...
Prominent YouTube content creators met at the White House with U.S. President Obama to discuss how government could better connect with the "YouTube generation".[307][308]
...
Some YouTube videos have themselves had a direct effect on world events, such as Innocence of Muslims (2012) which spurred protests and related anti-American violence internationally.[312] TED curator Chris Anderson described a phenomenon by which geographically distributed individuals in a certain field share their independently developed skills in YouTube videos, thus challenging others to improve their own skills, and spurring invention and evolution in that field.[297] Journalist Virginia Heffernan stated in The New York Times that such videos have "surprising implications" for the dissemination of culture and even the future of classical music.[313]

A 2017 article in The New York Times Magazine posited that YouTube had become "the new talk radio" for the far right.[314] Almost a year before YouTube's January 2019 announcement that it would begin a "gradual change" of "reducing recommendations of borderline content and content that could misinform users in harmful ways",[315] Zeynep Tufekci had written in The New York Times that, "(g)iven its billion or so users, YouTube may be one of the most powerful radicalizing instruments of the 21st century".[316] Under YouTube's changes to its recommendation engine, the most-recommended channel evolved from conspiracy theorist Alex Jones (2016) to Fox News (2019).[317] According to a 2020 study, viewership of far-right videos on YouTube peaked in 2017 and "a growing body of journalistic evidence" suggested that YouTube was radicalizing young men through its recommendation engine, but that such evidence was "fraught with a bias towards sensationalism". It also found more "mainstream-adjacent Conservative creators" gaining over alt-right and extremist videos by 2020.[318] A 2022 study found that "despite widespread concerns that YouTube's algorithms send people down 'rabbit holes' with recommendations to extremist videos, little systematic evidence exists to support this conjecture", and that such exposure was "heavily concentrated among a small group of people with high prior levels of gender and racial resentment."[319] A 2024 study by the Institute for Strategic Dialogue found that YouTube frequently recommended Christian videos and right-leaning and culturally conservative "culture war" videos by Fox News and male lifestyle influencers to accounts that did not show an interest in such topics.[320]

The Legion of Extraordinary Dancers[321] and the YouTube Symphony Orchestra[322] selected their membership based on individual video performances.[297][322] Further, the cyber-collaboration charity video "We Are the World 25 for Haiti (YouTube edition)" was formed by mixing performances of 57 globally distributed singers into a single musical work,[323] with The Tokyo Times noting the "We Pray for You" YouTube cyber-collaboration video as an example of a trend to use crowdsourcing for charitable purposes.[324] The anti-bullying It Gets Better Project expanded from a single YouTube video directed to discouraged or suicidal LGBT teens,[325] that within two months drew video responses from hundreds including U.S. President Barack Obama, Vice President Biden, White House staff, and several cabinet secretaries.[326] Similarly, in response to fifteen-year-old Amanda Todd's video "My story: Struggling, bullying, suicide, self-harm", legislative action was undertaken almost immediately after her suicide to study the prevalence of bullying and form a national anti-bullying strategy.[327] In May 2018, after London Metropolitan Police claimed that drill music videos glamorizing violence gave rise to gang violence, YouTube deleted 30 videos.[328]
...
YouTube entered into a marketing and advertising partnership with NBC in June 2006.[339] In March 2007, it struck a deal with the BBC for three channels with BBC content, one for news and two for entertainment.[340] In November 2008, YouTube reached an agreement with MGM, Lions Gate Entertainment, and CBS, allowing the companies to post full-length films and television episodes on the site, accompanied by advertisements in a section for U.S. viewers called "Shows". The move was intended to create competition with websites such as Hulu, which features material from NBC, Fox, and Disney.[341][342] In November 2009, YouTube launched a version of "Shows" available to UK viewers, offering around 4,000 full-length shows from more than 60 partners.[343] In January 2010, YouTube introduced a film rentals service,[344] available in many countries, and TV shows can be bought in several countries.[345][346] The service offers over 6,000 films.[347]

2017 advertiser boycott
In March 2017, the government of the United Kingdom pulled its advertising campaigns from YouTube, after reports that its ads had appeared on videos containing extremist content. The government demanded assurances that its advertising would "be delivered safely and appropriately". The Guardian newspaper, as well as other major British and U.S. brands, similarly suspended their advertising on YouTube in response to their advertising appearing near offensive content. Google stated that it had "begun an extensive review of our advertising policies and have made a public commitment to put in place changes that give brands more control over where their ads appear".[348][349]

In early April 2017, the YouTube channel h3h3Productions presented evidence claiming that a Wall Street Journal article had fabricated screenshots showing major brand advertising on an offensive video containing Johnny Rebel music overlaid on a Chief Keef music video, citing that the video itself had not earned any ad revenue for the uploader. The video was retracted after it was found that the ads had been triggered by the use of copyrighted content in the video.[350][351] On April 6, 2017, YouTube announced that to "ensure revenue only flows to creators who are playing by the rules", it would change its practices to require that a channel undergo a policy compliance review, and have at least 10,000-lifetime views, before they may join the YouTube Partner Program.[352]

YouTuber earnings

Total annual earnings of the top ten YouTuber accounts, and the income of the single highest-earning account for 2017
In May 2007, YouTube launched its Partner Program (YPP), a system based on AdSense which allows the uploader of the video to share the revenue produced by advertising on the site.[353] YouTube typically takes 45 percent of the advertising revenue from videos in the Partner Program, with 55 percent going to the uploader.[354][355] There are over two million members of the YouTube Partner Program.[356] According to TubeMogul, in 2013 a pre-roll advertisement on YouTube (one that is shown before the video starts) cost advertisers on average $7.60 per 1000 views. Usually, no more than half of the eligible videos have a pre-roll advertisement, due to a lack of interested advertisers.[357]

YouTube's policies restrict certain forms of content from being included in videos being monetized with advertising, including videos containing violence, strong language, sexual content, "controversial or sensitive subjects and events, including subjects related to war, political conflicts, natural disasters and tragedies, even if graphic imagery is not shown" (unless the content is "usually newsworthy or comedic and the creator's intent is to inform or entertain"),[358] and videos whose user comments contain "inappropriate" content.[359]

In 2013, YouTube introduced an option for channels with at least a thousand subscribers to require a paid subscription for viewers to watch videos.[360][361] In April 2017, YouTube set an eligibility requirement of 10,000 lifetime views for a paid subscription.[362] On January 16, 2018, the eligibility requirement for monetization was changed to 4,000 hours of watch-time within the past 12 months and 1,000 subscribers.[362] The move was seen as an attempt to ensure that videos being monetized did not lead to controversy, but was criticized for penalizing smaller YouTube channels.[363] YouTube Play Buttons, a part of the YouTube Creator Rewards, are a recognition by YouTube of its most popular channels.[364] The trophies are made of nickel plated copper-nickel alloy, golden plated brass, silver plated metal, ruby, and red tinted crystal glass. They are given to channels with at least one hundred thousand, a million, ten million, fifty million subscribers, and one hundred million subscribers, respectively.[365][366]

YouTube's policies on "advertiser-friendly content" restrict what may be incorporated into videos being monetized; this includes strong violence, language,[367] sexual content, and "controversial or sensitive subjects and events, including subjects related to war, political conflicts, natural disasters and tragedies, even if graphic imagery is not shown", unless the content is "usually newsworthy or comedic and the creator's intent is to inform or entertain".[368] In September 2016, after introducing an enhanced notification system to inform users of these violations, YouTube's policies were criticized by prominent users, including Philip DeFranco and Vlogbrothers. DeFranco argued that not being able to earn advertising revenue on such videos was "censorship by a different name". A YouTube spokesperson stated that while the policy itself was not new, the service had "improved the notification and appeal process to ensure better communication to our creators".[369][370][371] Boing Boing reported in 2019 that LGBT keywords resulted in demonetization.[372] In the United States as of November 2020, and June 2021 worldwide,[373] YouTube reserves the right to monetize any video on the platform, even if their uploader is not a member of the YouTube Partner Program. This will occur on channels whose content is deemed "advertiser-friendly", and all revenue will go directly to Google without any share given to the uploader.[374]
...
/*console.log(calculateTotalStrain(["q","w","e","r","t","y","u","i","o","p",
"a","s","d","f","g","h","j","k","l",
"z","x","c","v","b","n","m"]));*/
...
async function startTheTraining(){
    ...
    for (let gen=0;gen<generations;gen++){
        let newPopulation=[];
        //pick the top ceil(sqrt(populationSize)) layouts
    ...
    statusspan.innerHTML=`${gen+1}/${generations} complete, current best ${bestStrain.toFixed(0)}.<br> ${(100-100*(bestStrain/12088245)).toFixed(0)}% better than QWERTY`;
